--DROP VIEW IF EXISTS views.v_autobahn_bruecke_be; 

CREATE VIEW  views.v_autobahn_bruecke_be  AS
...
WHERE 'Basis-DLM' = ANY(fahrstrasse_union.advstandardmodell) 			-- selber Effekt 
	AND ax_strasse.widmung = 1301 
; 


ALTER TABLE views.v_autobahn_bruecke_be OWNER TO postgres;
